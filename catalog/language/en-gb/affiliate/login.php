...
$_['text_register_account']         = '<p class="sub-heading">I am not currently an affiliate.</p><p class="register">Click Continue below to create a new affiliate account. Please note that this is not connected in any way to your customer account.</p>';
