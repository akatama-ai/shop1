<?php 
class ControllerExtensionPaymentStripePayments extends Controller {
	private $error = array(); 
	...
	public function index() {
		...
		$data['action'] = HTTPS_SERVER . 'index.php?route=extension/payment/stripe_payments&token=' . $this->session->data['token'];
