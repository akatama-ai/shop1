...
class ControllerDesignLayout extends Controller {
	...
	protected function getForm() {
		...
		$data['text_column_right'] = $this->language->get('text_column_right');
            ...
            /*custom*/
                $data['text_ctop_full'] = $this->language->get('text_ctop_full');
		$data['text_cbottom_full'] = $this->language->get('text_cbottom_full');
                $data['text_ftop_full'] = $this->language->get('text_ftop_full');
		$data['text_fbottom_full'] = $this->language->get('text_fbottom_full');
