              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="blogger_description[<?php echo $language['language_id']; ?>][title]" value="<?php echo isset($blogger_description[$language['language_id']]) ? $blogger_description[$language['language_id']]['title'] : ''; ?>" placeholder="<?php echo $entry_title; ?>" id="input-title<?php echo $language['language_id']; ?>" class="form-control" />
                  ...
                  <div class="form-group required">
                    ...
                    <div class="col-sm-10">
                      <textarea name="blogger_description[<?php echo $language['language_id']; ?>][description]" placeholder="<?php echo $entry_description; ?>" id="input-description<?php echo $language['language_id']; ?>" class="form-control summernote"><?php echo isset($blogger_description[$language['language_id']]) ? $blogger_description[$language['language_id']]['description'] : ''; ?></textarea>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select name="module_id" id="input-module" class="form-control">
                    ...
                    <?php foreach ($blogger_modules as $module) { ?>
